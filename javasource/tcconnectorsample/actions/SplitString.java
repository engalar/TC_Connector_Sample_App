...
package tcconnectorsample.actions;

import java.util.ArrayList;
import java.util.List;
import com.mendix.systemwideinterfaces.core.IContext;
import com.mendix.webui.CustomJavaAction;
import tcconnectorsample.proxies.ResultString;
...
public class SplitString extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	public java.util.List<IMendixObject> executeAction() throws Exception
	{
		...
		if ((DelimitedString != null) && (DelimitedString.trim() != "")){
			...
			throw new com.mendix.systemwideinterfaces.MendixRuntimeException("The string provided to SplitString action cannot be blank or empty.");
		}
		// END USER CODE
	}
