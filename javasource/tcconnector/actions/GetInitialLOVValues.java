...
public class GetInitialLOVValues extends CustomJavaAction<IMendixObject>
{
	...
	{
		this.inputEntity = __inputEntity == null ? null : tcconnector.proxies.GetInitialLOVValuesInputEntity.initialize(getContext(), __inputEntity);
		...
		response = (GetLOVValuesResponse) TcConnection.callTeamcenterService(getContext(),
				...
				SERVICE_OPERATION_MAP, null, configurationName);
