...
public class ReviseObjects extends CustomJavaAction<IMendixObject>
{
	...
	{
		this.objectToRevise = __objectToRevise == null ? null : tcconnector.proxies.WorkspaceObject.initialize(getContext(), __objectToRevise);

		this.reviseInput = __reviseInput == null ? null : tcconnector.proxies.ReviseInputs.initialize(getContext(), __reviseInput);
