...
public class UploadTemporaryFiles extends CustomJavaAction<java.util.List<IMendixObject>>
{
	...
	{
		this.Files = new java.util.ArrayList<tcconnector.proxies.FileDocument>();
		if (__Files != null)
			for (IMendixObject __FilesElement : __Files)
				this.Files.add(tcconnector.proxies.FileDocument.initialize(getContext(), __FilesElement));
