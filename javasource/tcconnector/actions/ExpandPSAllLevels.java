...
public class ExpandPSAllLevels extends CustomJavaAction<IMendixObject>
{
	...
	public ExpandPSAllLevels(IContext context, IMendixObject InputEntity, java.lang.String BusinessObjectMappings, java.lang.String ConfigurationName)
	{
		super(context);
	...
	{
		this.InputEntity = __InputEntity == null ? null : tcconnector.proxies.ExpandPSOneLevelInput.initialize(getContext(), __InputEntity);
